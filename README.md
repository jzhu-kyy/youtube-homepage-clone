...
- FocusTube learning mode with a topic-shaped feed, live study timer, Shorts and entertainment filtering, off-topic nudges, persistent session summaries, and two simulated videos for demonstrating on-topic vs. off-topic outcomes.
